  ...
  return (
    <section className="mx-auto flex min-h-[60vh] w-full max-w-3xl flex-col justify-center px-4 py-12">
      <div className="rounded-lg border border-border bg-card p-6 shadow-sm">
        ...
        <p className="text-sm font-medium text-muted-foreground">{t("error.workspace.eyebrow")}</p>
        <h1 className="mt-2 text-2xl font-semibold text-foreground">{t("error.workspace.title")}</h1>
        <p className="mt-3 text-sm leading-6 text-muted-foreground">
          {t("error.workspace.description")}
        </p>
