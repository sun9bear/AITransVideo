...
const GENERAL_FAQ: FaqItem[] = [
  ...
  },
  {
    ...
    a: "Rask、HeyGen、ElevenLabs 都是优秀的全球化平台，有些在数字人或声音克隆上非常强。爱译视频的重点不一样——我们更关注中文创作者处理海外长视频的实际需求：更长的视频时长、更低的使用门槛、多种结果导出，以及生成后还能逐句修改和单段重生成。",
  },
  {
    q: "如果 AI 翻译不满意怎么办？",
  ...
  },
  {
    ...
    a: "Express 模式自动跑完全流程，速度快、成本低，适合先验证效果或批量出片；Studio 模式可以在工作台里逐句复核、克隆原声音色，质量更稳，更适合需要发布或交付客户的内容。",
  },
  {
    q: "可以下载哪些结果？",
