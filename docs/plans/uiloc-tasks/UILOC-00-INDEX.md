...
| UI-06 | [always-on 用户页](UI-06-app-user-flows.md) | ◐ | Phase 2 · T2.2 | L | **part1 账户页 [PR #85](https://github.com/sun9bear/AITransVideo/pull/85) 已合并（squash `99511f6d`）**（projects/voices/settings/help/notifications/billing，332 key）；**part2 核心工作台**薄切片方案见 [UI-06-part2-workbench-slices](UI-06-part2-workbench-slices.md)（W1-W5）：**W1 任务详情→结果/下载 [PR #87](https://github.com/sun9bear/AITransVideo/pull/87) 已合（squash `805cb92c`）** + **W2a 创建表单 chrome [PR #88](https://github.com/sun9bear/AITransVideo/pull/88) 已合（squash `4c0a5d36`）**（~110 CJK → appTranslationForm，consent 14 串留 inline 待 W2b、克隆门逻辑零改；UI-09 chokepoint 接入，errors.code.* 拆跟进单）；**W2b/W3/W4/W5 待做**（法务面 W2b/W4 = Claude 把关忠实翻译+标疑点，§2 owner 决策；下一片 W2b consent 或 W3 Studio 审校） |
