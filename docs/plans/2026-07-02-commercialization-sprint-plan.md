...
|---|---|---|---|---|
| CM-01 topup 购买链路 | ✅ 已合并（2026-07-02，项目主授权） | PR #94（基线 bump，74a5614b）+ PR #95 | 91e5ee3c | 外审：5-lens 对抗（P1+2×P2+P3 全修）+ CodeX CLI 两轮（P2 全修，第三轮限额→主模型终审兜底）+ @codex bot（3×P2 全修）；33 新测试 + 377 回归绿。部署+激活见 §4.2 |
