...
|---|---|---|---|---|
| CM-01 topup 购买链路 | 🔄 评审收敛完毕，待合并（前置 #94 基线 bump 先合并） | claude/cm01-topup / PR #95 | | 外审：5-lens 对抗（P1+2×P2+P3 全修）+ CodeX CLI 两轮（P2 全修，第三轮限额→主模型终审兜底）+ @codex bot（3×P2 全修）；33 新测试 + 377 回归绿 |
